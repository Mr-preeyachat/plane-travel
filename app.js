const tripData = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?auto=format&fit=crop&w=1400&q=85',
    ...
    events: [
          ['01:10', '✈️ DEPARTURE', `เที่ยวบินออกจากประเทศไทย (ดอนเมือง/สุวรรณภูมิ):
          ...
          ['08:40', '✈️ ARRIVAL', `เดินทางถึง Kansai International Airport (KIX) Terminal 1:
          • รถลงที่อาคารผู้โดยสารขาเข้า เดินตามป้าย "Arrivals / Immigration" เข้าสู่อาคารหลัก`],

          ['08:40 - 09:40', '👨‍✈️ IMMIGRATION & BAGGAGE', `ขั้นตอนการผ่านด่านเข้าเมืองและรับกระเป๋า:
          ...
          ['09:40 - 10:40', '🚈 KIX TO DOBUTSUEN-MAE', `เดินทางจากสนามบินคันไซ เข้าสู่ตัวเมืองโอซากะ:
          • ขึ้นเอสการ์เลเตอร์/ลิฟต์ไปชั้น 2 เดินข้ามทางเชื่อมไปสถานีรถไฟ Kansai-Airport Station
          • แตะบัตร IC Card หรือซื้อตั๋ว Nankai Airport Express (สาย Nankai Main Line) มุ่งหน้า Namba
          ...
          ['10:40 - 11:10', '👜 LUGGAGE DROP', `นำกระเป๋าเดินทางไปฝากที่ Fujiya Locker:
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&w=1400&q=85',
...
• เดินเล่นถ่ายรูปรับลมทะเลบริเวณท่าเรือริมอ่าว`],
      ...
      ['16:30 - 17:15', 'TRAVEL TO UMEDA', `เดินทางจากอ่าวโอซากะ ไปย่านโอฮาซึ เท็นจิน (Umeda / Sonezaki):
...
• เดินเท้ากลับเข้าที่พัก พักผ่อนตามอัธยาศัย`]
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?auto=format&fit=crop&w=1400&q=85',
